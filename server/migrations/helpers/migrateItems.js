 ...
 * collection and not as subdocuments of the meeting series anymore. This means
 * that we have to adjust this class if we want to use it for later migrations,
 * too.
 */
